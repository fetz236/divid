  ...
  >
    ...
    <HomeStack.Screen
      ...
      options={{
        ...
        headerTitleStyle: header_style.title,
        headerTintColor: "white",
        headerTitle: " Contact Preferences",
      }}
    />
    <HomeStack.Screen
      name="ReferUserScreen"
      component={ReferUserScreen}
      options={{
        headerShown: true,
        headerStyle: header_style.full_container,
        headerBackTitleVisible: false,
    ...
    />
    <HomeStack.Screen
      name="FindAddressScreen"
      component={FindAddressScreen}
      options={{ presentation: "modal" }}
    />
    <HomeStack.Screen
      name="CurrentAddressScreen"
      component={CurrentAddressScreen}
      options={{ presentation: "modal" }}
    />
    <HomeStack.Screen
      name="LoginAddressNeededScreen"
      component={LoginAddressNeededScreen}
      options={{ presentation: "modal" }}
    />
  </HomeStack.Navigator>
);
...
const SearchStackScreen = () => (
  ...
  >
    ...
    <SearchStack.Screen
      name="DisplayCategoriesScreen"
      component={DisplayCategoriesScreen}
      options={{
        headerShown: true,
        headerStyle: header_style.full_container,
        headerBackTitleVisible: false,
