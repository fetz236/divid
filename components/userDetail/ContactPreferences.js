  ...
  return (
    <View style={contact_preferences_style.main_container}>
      ...
      <ContactCheck
        ...
        setEmailAccepted={setEmailAccepted}
        mobile_accepted={mobile_accepted}
        setMobileAccepted={setMobileAccepted}
      />
    </View>
  );
}
...
const ContactPreferencesBody = () => (
  <View>
    ...
    <View style={contact_preferences_style.body_container}>
      <Text style={contact_preferences_style.sub_heading}>
        You can edit and change any contact preferences in this section
      </Text>
    </View>
    <View style={contact_preferences_style.body_container}>
      <Text style={contact_preferences_style.sub_heading}>
        Please note emails for receipts and other necessary information will be
