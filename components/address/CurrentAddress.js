      ...
      {isActiveLoaded && (
        <View style={current_address_style.main_container}>
          <MaterialCommunityIcons
            ...
            color="#d95a00"
            size={50}
            style={current_address_style.close_button}
          ...
          <TouchableOpacity
            style={current_address_style.ana_box}
            onPress={() =>
...
const DisplayCurrentAddresses = (props) => (
  ...
  >
    <View style={current_address_style.dca_info}>
      {props.item.isActive && (
        <Text style={current_address_style.dca_info_active}>
          Active address
        </Text>
      )}
    </View>
    ...
    <View style={current_address_style.dca_info}>
      <Text style={current_address_style.dca_info_text}>
        {props.item.address1}, {props.item.address2}, {props.item.postcode}
      </Text>
    </View>
  </TouchableOpacity>
);
