...
import {
  worker_style,
  worker_schedule,
} from "../../styles/workers/ViewWorkerStyle";
    ...
    <View>
      <View>
        <ScrollView>
          ...
          <View style={worker_schedule.schedule_container}>
            <View style={worker_schedule.schedule_button_style}>
              <TouchableOpacity
                style={worker_schedule.touchable_opacity}
                onPress={() =>
                  navigation.navigate("WorkerScheduleDetail", {
                    worker: worker,
                  })
                }
              >
                <Text style={worker_schedule.button_text}> View Schedule </Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
...
const WorkerImage = (props) => (
  <>
    <Image
      style={worker_style.worker_image}
