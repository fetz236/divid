...
const ModifyMain = () => (
  <View>
    <View style={modify_home_style.modify_container}>
      <Text style={modify_home_style.modify_header}>
        {" "}
        You are able to modify your booking
      </Text>
    </View>
    <View style={modify_home_style.modify_info}>
      <Text style={modify_home_style.modify_text}>
        You may be charged a fee for modifying the booking
      </Text>
    </View>
  </View>
);
...
const ModifyDate = (props) => (
  <View style={modify_home_style.confirm_modification}>
    <View style={modify_home_style.confirm_container}>
      <Text style={modify_home_style.title}>
        Select a new date and time for your worker
      </Text>
    </View>
...
const AcceptTerms = (props) => (
  <View style={modify_home_style.accept_terms}>
    <View style={modify_home_style.confirm_container}>
      <Text style={modify_home_style.sub_heading}>
...
const ConfirmModification = (props) => (
  <View style={modify_home_style.confirm_modification}>
    ...
    <View style={modify_home_style.all_buttons}>
      <TouchableOpacity
        style={modify_home_style.button_container}
